...
class UserController {
  ...
  static async enviarEmailsCadastro(user) {
    ...
    await transporter.sendMail({
      ...
      subject: "Cadastro de usuário do Sistema de Fazenda",
      html: `
    ...
    await transporter.sendMail({
      from: "cotec@sde.ce.gov.br",
      to: user.user_email,
      subject: "Código PIN - Sistema de controle da Fazenda",
      html: `
      <h2>Código PIN</h2>
      <h3>${user.user_pin}</h3>
      <p>
        <a href="https://www.sistemafazenda.com.br/resetSenha">
  ...
  static async gerarPin(req, res) {
    ...
    try {
      ...
      var mailOptions = {
        ...
        html: `<h3>Segue o novo Pin!!</h3><p><strong>${newPin}</strong><br>Crie sua nova senha no seguinte link: <a href="https://sistemafazenda.com.br/resetSenha">Resetar Senha</a>`,
      };
  ...
  static async login(req, res) {
    ...
    try {
      ...
      const token = jwt.sign(
        {
          _id: verificaUser.id,
          _profile_id: verificaUser.perfil_id,
